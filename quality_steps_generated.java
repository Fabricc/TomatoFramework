...
@Given("^\\[the (?:probability|chance) (?:of|to|that|in which) \"([^\"]*)\" ((within the next|in less than)|(after|in more than)) ([0-9]*.[0-9]+|[0-9]+) is ((at most|at least)|((greater than|higher than)|(lower than|less than))) (0.[0-9]+|1)\\]$")
