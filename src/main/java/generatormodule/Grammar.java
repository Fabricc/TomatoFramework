...
import generatormodule.support.IllegalExpressionException;
import generatormodule.support.SemanticWrapper;
import generatormodule.support.TermOccurrence;
import generatormodule.support.helper;
...
//        expressions.put("thanLowerBound","greaterThan");
        ...
        syntax.put("ROCOF", "'rocof'|'rate of occurrence of failures'");
        syntax.put("POFOD", "'pofod'|'probability of failures on demand'");
        syntax.put("MTTF", "'mttf'|'mean time to failure'");
        syntax.put("reliabilityBound", "reliabilityUpperBound|reliabilityLowerBound");
        syntax.put("reliabilityUpperBound", "lowerThan");
        syntax.put("reliabilityLowerBound", "greaterThan");
        
        
        semantic.put("reliabilityMetric",new SemanticWrapper("reliability metric"));
        semantic.put("ROCOF", new SemanticWrapper("rocof"));
        semantic.put("POFOD", new SemanticWrapper("pofod"));
        semantic.put("MTTF", new SemanticWrapper("mttf"));
        semantic.put("reliabilityBound",new SemanticWrapper("reliability bound"));
        semantic.put("reliabilityUpperBound",new SemanticWrapper("<"));
        semantic.put("reliabilityLowerBound",new SemanticWrapper(">"));
    }
